package br.com.soundapp.soundapp.principal;

import br.com.soundapp.soundapp.model.Artista;
import br.com.soundapp.soundapp.model.Musica;
import br.com.soundapp.soundapp.model.TipoArtista;
...
public class Principal {
    ...
    private void cadastrarArtistas() {
        ...
        while (cadastrarNovo
            ...
            var nome = leitura.nextLine();
            System.out.print("Informe o tipo desse artista:" +
                    " (solo, dupla ou banda)");
            var tipo = leitura.nextLine();
            TipoArtista tipoArtista = TipoArtista
                    .valueOf(tipo.toUpperCase());
            Artista artista = new Artista(nome, tipoArtista);
            repositorio.save(artista);
            System.out.println("Castrar novo artista? (S/N)");
